  ...
  <div className="max-w-7xl mx-auto text-center">
    ...
    <div className="grid md:grid-cols-3 sm:grid-cols-1 gap-8">
      ...
      <div className="bg-white p-6 shadow-lg rounded-lg">
        ...
        <h3 className="text-xl font-semibold text-teal-700">E-commerce website </h3>
        <p className="text-gray-700 mt-4">A responsive website built using  Next.js and sanity for CMS.</p>
      </div>
      ...
      <div className="bg-white p-6 shadow-lg rounded-lg">
        ...
        <h3 className="text-xl font-semibold text-teal-700">Portfolio </h3>
        <p className="text-gray-700 mt-4">A beautiful portfolio website built using modern web technologies.</p>
      </div>
      ...
      <div className="bg-white p-6 shadow-lg rounded-lg">
        ...
        <h3 className="text-xl font-semibold text-teal-700">Blog </h3>
        <p className="text-gray-700 mt-4">A blog website designed with an emphasis on user experience.</p>
      </div>
    </div>
  </div>
</section>
